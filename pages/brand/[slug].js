...
import { Art, Branding } from '../../components'

const BrandDetails = ({ art, arts }) => {
...
export const getStaticProps = async ({ params: { slug }}) => {
    const query = `*[_type == "branding" && slug.current == '${slug}'][0]`;
    const artsQuery = '*[_type == "branding"]'
